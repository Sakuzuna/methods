/*  
node test.js example.com 60 16 proxy.txt 128 GET
*/
...
let headerGenerator = new HeaderGenerator({
    browsers: [
        ...
        {name: "edge", minVersion: 49, httpVersion: "2"},
        {name: "opera", minVersion: 65, httpVersion: "2"},
    ...
    locales: ["en-US", "en-GB", "fr-FR", "es-ES", "de-DE", "es", "de", "fr", "gb", "us", "en"]
});
...
if (process.argv.length !== 8) {
    console.log("Invalid syntax! \nnode test target time threads proxy.txt rps GET\nExample: node test https://google.com/ 60 16 proxy.txt 128 GET");
    process.exit(1);
}
